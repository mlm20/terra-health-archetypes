...
A fast, privacy-first, no-login web demo where users can get a one-of-a-kind **Health Archetype** (text + avatar image), and can copy/download a beautifully generated card to share.

**Core Experience:**
1. AI analyzes health data (mocked for now).
2. A custom archetype + avatar is generated.
3. All data is session-based and processed in memory; nothing is saved.
...
- **APIs:** OpenAI (LLM for text and DALL-E 3 for image generation)
